...
class UserEmbed(discord.Embed):
    ...
    async def load_users(self):
        users = await get_users(self.http_client)
        ...
        roles_list = []
        for user in users:
            roles = await get_user_roles(self.http_client, user.id)
...
class RoleEmbed(discord.Embed):
    ...
    async def load_roles(self):
        roles = await get_roles(self.http_client)
...
class EventTypeEmbed(discord.Embed):
    ...
    async def load_event_types(self):
        event_types = await get_event_types(self.http_client)
...
class RoleEventTypeEmbed(discord.Embed):
    ...
    async def load_role_event_types(self):
        role_event_types = await get_role_event_types(self.http_client)
